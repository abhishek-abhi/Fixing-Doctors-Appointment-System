...
<script type="text/javascript" src="/webjars/jquery/2.1.4/jquery.min.js"></script>
   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <p class="lead"><h1>Fixing Doctors Appointment System</h1></p>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="light my-4">
            <p class="text-faded mb-4">Now fix your appointment with your doctors in few seconds. So, what are you waiting for?</p>
            <a class="btn btn-light btn-xl js-scroll-trigger" href="#services">Welcome</a>
          </div>
        </div>
      </div>
    </section>
